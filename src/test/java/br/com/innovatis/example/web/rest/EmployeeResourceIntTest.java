...
import br.com.innovatis.example.domain.Employee;
import br.com.innovatis.example.repository.EmployeeRepository;
...
import static br.com.innovatis.example.web.rest.TestUtil.createFormattingConversionService;
...
public class EmployeeResourceIntTest {
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNickName()).isEqualTo(DEFAULT_NICK_NAME);
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNickName()).isEqualTo(UPDATED_NICK_NAME);
